...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 pb-24 font-sans selection:bg-socar-100">
      {/* Header Profile Area (Decorative) */}
      <div className="bg-socar-600 h-64 absolute top-0 left-0 w-full -z-10 rounded-b-[3rem] shadow-sm"></div>

      <main className="max-w-4xl mx-auto px-4 pt-12">
        <header className="mb-8 text-white flex justify-between items-end">
          <div>
            <h1 className="text-3xl font-extrabold tracking-tight mb-2 opacity-95">💰 나의 가계부</h1>
            <p className="text-socar-100/80 font-medium">스마트하게 관리하는 자산 현황</p>
          </div>
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-20">
            <div className="w-12 h-12 border-4 border-socar-200 border-t-socar-600 rounded-full animate-spin"></div>
            <p className="mt-4 text-socar-600 font-medium animate-pulse">데이터를 동기화하는 중...</p>
          </div>
        ) : (
